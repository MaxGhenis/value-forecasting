...
If you hold the prior that, as it turns out, every model I tested holds — *liberalization continues* — GSS 2024 is new information.
...
(The pilot was also unweighted; everything here uses NORC's recommended weights.) The same pilot included a calibrated GPT-4o run producing long-horizon projections — same-sex-relations acceptance at 66 by 2030 (80% CI [57, 75]), 80 by 2100. GSS 2024's 55.9 already sits below that 2030 interval's floor.

A design like that asks a model to "forecast" years it has already read about, on items it can name, and reports recall as skill. I had flagged contamination as a concern and run what I thought was a control — a clean 2024 holdout — while the headline number still came from the leaky design. The right response was to rebuild the experiment with the controls load-bearing, which is what this is.

Credit in the other direction: the one thing the pilot got right — reversals happen and trend-extrapolators miss them — turned out to be the *most* important feature of the new data, and I pre-registered it this time ("all arms miss the HOMOSEX reversal; point ≥ 60 vs. actual ≈ 55"). It confirmed exactly.
...
The proposal, stated with the care the results demand:
...
*This develops the value-forecasting research program from a book I'm writing, [Society in Silico](https://society-in-silico.org). Feedback welcome, especially from people working on forecasting evaluation, survey methodology, and alignment targets — and criticism of the pre-analysis plan before I register the 2026 forecasts.*
